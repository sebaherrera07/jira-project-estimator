...
#  estimated_finish_date_with_uncertainty :date
...
class Estimation < ApplicationRecord
  ...
  validates :avg_weekly_earned_value, :epic_id, :estimated_finish_date, :last_completed_week_number,
            :remaining_earned_value, :remaining_weeks, :total_points, presence: true
